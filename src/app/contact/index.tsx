...
export function Contact() {
  return (
    <section data-testid="contact" id="contactSection" className="flex md:flex-row md:flex-wrap flex-col items-center justify-center gap-10 p-6 md:py-24 md:px-24 lg:px-32">

export function About() {
  return (
    <div data-testid="about" id="aboutSection" className="grid grid-cols-1 bg-about bg-no-repeat bg-cover bg-center md:bg-aboutLg md:grid-cols-6">
      ...
      <div className="grid justify-center mt-11 lg:mt-0 md:col-span-3 md:col-start-2 md:justify-start">
        <div className="w-80 h-14 bg-black rounded-md shadow-md shadow-black  md:w-full md:h-24 md:px-20">
          ...
          <div className="grid grid-cols-1 bg-black/80 text-white italic font-thin gap-4 px-9 py-11 mt-28 mb-11 shadow-lg shadow-black md:mb-0 md:col-span-2  md:text-2xl">
            <p>
              Welcome to Bistro Senca, a place dedicated to the pure joy of life. Our culinary inspiration knows no borders, bringing together global flavors in perfect harmony. 
            </p>
            <p>
            Whether you're gathering with friends or seeking a serene escape, Bistro Senca invites you to unwind and experience the essence of happiness.
            </p>
            <p>
              Join us in celebrating the magic of food and the embrace of companionship. Taste the world. Be at Bistro Senca.
            </p>
          </div>
        </section>
        <section className="grid grid-cols-1 justify-items-center items-end px-20 py-7 bg-white md:bg-white md:items-center md:col-start-5 md:col-span-1 md:p-0">
          <div className="grid grid-cols-1 justify-items-center gap-5 md:gap-0 ">
            <p className="text-center md:text-2xl md:row-start-2 md:text-black md:p-4">
              Bistro Senca boasts a rich heritage of culinary excellence that spans decades.
            </p>
